...
A texture pack and translation patch for [Render96ex](sm64pc.info)  
...
The voice in the intro cutscene was generated using [uberduck.ai](uberduck.ai). The voice in the ending cutscene is mine (once I do it).
